...
int global_debug_level[25];
string global_loc_tag[25] = {
...
//aman-essential-printing, simulation in refinement, clean print, smt-lib, mus-extraction, ternary-simulation,
//interpolation, bounded-model-checking
};
