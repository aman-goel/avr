...
#define FRONTEND_YOSYS "yosys"
#define FRONTEND_VMT "vmt"
#define FRONTEND_JG "jg"
#define FRONTEND_BTOR2 "btor2"
#define DEFAULT_FRONTEND FRONTEND_YOSYS
//#define DEFAULT_FRONTEND FRONTEND_VMT

class Config {
public:
	static bool g_random;
	static bool g_split_signals;
	static bool g_single_property;
...
private:
	...
	#define EN_SPLIT_SIGNALS "split_signals"
	#define SELECT_PROPERTY "property_select"
	#define INIT_FILE "init_file"
	#define SELECT_FRONTEND "frontend"
	#define JG_PREPROCESS "jg_preprocess"
